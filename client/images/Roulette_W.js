...
lib.ssMetadata = [
		{name:"Roulette_atlas_", frames: [[0,0,650,707],[402,1610,332,295],[804,901,332,295],[402,1313,332,295],[804,604,332,295],[1138,604,332,295],[1138,901,332,295],[1472,604,332,295],[1472,901,332,295],[804,1198,332,295],[1138,1198,332,295],[1472,1198,332,295],[736,1495,332,295],[652,0,400,300],[0,1313,400,300],[1054,0,400,300],[0,709,400,300],[652,302,400,300],[0,1011,400,300],[1054,302,400,300],[1456,0,400,300],[1456,302,400,300],[0,1615,400,300],[402,709,400,300],[402,1011,400,300]]}
];
...
(lib.Roulette = function(mode,startPosition,loop) {
	...
	// White
	this.instance_19 = new lib.Roulette_W_01();
	this.instance_19.parent = this;
	this.instance_19.setTransform(0,0,0.8,0.8);

	this.instance_20 = new lib.Roulette_W_02();
	this.instance_20.parent = this;
	this.instance_20.setTransform(0,0,0.8,0.8);

	this.instance_21 = new lib.Roulette_W_03();
	this.instance_21.parent = this;
	this.instance_21.setTransform(0,0,0.8,0.8);

	this.instance_22 = new lib.Roulette_W_04();
	this.instance_22.parent = this;
	this.instance_22.setTransform(0,0,0.8,0.8);

	this.instance_23 = new lib.Roulette_W_05();
	this.instance_23.parent = this;
	this.instance_23.setTransform(0,0,0.8,0.8);

	this.instance_24 = new lib.Roulette_W_06();
	this.instance_24.parent = this;
	this.instance_24.setTransform(0,0,0.8,0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_19}]},53).to({state:[{t:this.instance_20}]},1).to({state:[{t:this.instance_21}]},1).to({state:[{t:this.instance_22}]},1).to({state:[{t:this.instance_23}]},1).to({state:[{t:this.instance_24}]},1).to({state:[{t:this.instance_24}]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Roulette_atlas_W.png", id:"Roulette_atlas_"}
	],
	preloads: []
};
